...
public class OfferTypeService implements IService<OfferType> {
    ...
    public Mono<OfferType> findByNameIgnoreCase(String name) {
        return offerRepository.findByNameIgnoreCase(name);
    }

    public Flux<OfferType> findAllByMarketId(UUID marketId) {
